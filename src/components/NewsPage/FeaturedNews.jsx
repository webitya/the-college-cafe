          ...
          <div className="relative z-10 w-full h-full px-4 sm:px-6 lg:px-8 flex items-center justify-center">
            <div className="max-w-4xl mx-auto text-center">
              <div className="mb-4 sm:mb-6">
                <span className="inline-block bg-white/90 backdrop-blur-sm text-gray-900 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-2 rounded-full capitalize shadow-lg border border-white/50">
                  {article.category}
                </span>
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight text-balance px-2 drop-shadow-lg">
                {article.title}
              </h1>
              <div className="flex items-center justify-center text-white text-sm sm:text-base drop-shadow-md">
                <div className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full border border-white/30">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 mr-2 inline"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
