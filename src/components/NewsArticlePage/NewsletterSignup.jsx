  ...
  return (
    <section className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Never Miss Important Updates</h2>
        <p className="text-xl text-yellow-100 mb-8 max-w-2xl mx-auto">
          Subscribe to our newsletter and get the latest education news, exam notifications, and career opportunities
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center text-yellow-100">
          <div className="flex items-center">
            <span className="w-2 h-2 bg-yellow-200 rounded-full mr-2"></span>
            Daily education updates
          </div>
          <div className="flex items-center">
            <span className="w-2 h-2 bg-yellow-200 rounded-full mr-2"></span>
            Exam notifications
